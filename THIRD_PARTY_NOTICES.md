...
This website intentionally uses no CDN, analytics SDK, ad SDK or externally
hosted webfont.

- The project described by the site currently uses a Linux-/Ubuntu-based
  engineering foundation. Linux, Ubuntu and associated components remain under
  their respective licences and trademarks.
- GitHub and GitHub Pages are trademarks/services of GitHub, Inc. The project
  is not endorsed by GitHub.
- Microsoft, Windows, Canonical, Ubuntu, Linux, Marvel and Disney names or
  marks, if mentioned for factual compatibility or non-affiliation statements,
...
release. No operating-system software is distributed by this website.
